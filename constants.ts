...
export const TRANSLATIONS = {
  ...
  ar: {
    ...
    fastShippingDesc: "يصلك الطلب خلال 24-36 ساعة.",
    qualityGuarantee: "الدفع عند الاستلام",
    qualityDesc: "يمكنك الدفع نقداً عند استلام طلبك.",
    ...
    aiIntro: "مرحباً! أنا {name}، مساعدك الذكي للأناقة. هل تبحث عن طابع معين؟",
    hours: "ساعة",
    ...
    inStock: "متوفر",
    hurryOnly: "سارع! تبقى فقط",
    leftInStock: "في المخزون",
