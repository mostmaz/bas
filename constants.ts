...
export const TRANSLATIONS = {
    en: {
        ...
        deliveryDelay: 'Delivery currently may be delayed for 3 days due to customs tariff issues',
    ...
    ar: {
        ...
        deliveryDelay: 'التوصيل حاليا قد يتاخر لمدة 3 ايام بسبب مشاكل التعرفة الكمركية',
