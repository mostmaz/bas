...
export const Home: React.FC = () => {
  const { products, brands, t, searchQuery, orders } = useShop();
          ...
          {displayBrands.map((brand, index) => {
             ...
             return (
                <button
                  ...
                  className={`flex items-center gap-3 pl-2 pr-4 py-2 rounded-full border transition-all whitespace-nowrap ${
                    isSelected 
