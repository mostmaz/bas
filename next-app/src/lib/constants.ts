...
export const INITIAL_CAROUSEL_SLIDES: CarouselSlide[] = [
    {
        id: '0',
...
export const TRANSLATIONS = {
    en: {
        ...
        fastShippingDesc: "Delivery within 24-36 hours.",
        qualityGuarantee: "Cash on Delivery",
        qualityDesc: "Pay securely when you receive your order.",
        ...
        aiIntro: "Hi! I'm Layla, your AI style assistant. Looking for a specific vibe?",
        hours: "hours",
    ...
    ar: {
        ...
        fastShippingDesc: "التوصيل خلال 24-36 ساعة.",
        qualityGuarantee: "الدفع عند الاستلام",
        qualityDesc: "ادفع بأمان عند استلام طلبك.",
        ...
        aiIntro: "مرحباً! أنا ليلى، مساعدك الذكي للأناقة. هل تبحث عن طابع معين؟",
        hours: "ساعة",
