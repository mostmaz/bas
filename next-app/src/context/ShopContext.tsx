...
import { INITIAL_PRODUCTS, INITIAL_BRANDS, TRANSLATIONS, DEVICES } from '@/lib/constants';
...
export const ShopProvider: React.FC<ShopProviderProps> = ({ children, initialData }) => {
